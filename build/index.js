...
class Like {
  ...
  events() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.like-box').on('click', this.likeDispatcher.bind(this));
  }
  likeDispatcher(e) {
...
class MyNotes {
  ...
  createNote(e) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      success: post => {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(`<li data-id="${post.id}">
      ...
      error: response => {
        if (response.responseText == "You have reached your note limit") jquery__WEBPACK_IMPORTED_MODULE_0___default()('.note-limit-message').addClass('active');
        console.log('Sorry');
        console.log(response);
      }
    });
  ...
  updateNote(e) {
    const note = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).parents("li");
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      beforeSend: xhr => {
        xhr.setRequestHeader('X-WP-Nonce', universityData.nonce);
      },
...
class Search {
      ...
      this.resultsDiv.html(`
                <div class="row">
                    <div class="one-third">
                        ...
                        ${results.general_info.length ? `<ul class="link-list min-list">
  ...
  keyPressDispatcher(e) {
    ...
    if (e.keyCode == 83 && !this.isOverlayOpen && !jquery__WEBPACK_IMPORTED_MODULE_0___default()("input, textarea").is(':focus')) this.openOverlay();else if (e.keyCode == 27 && this.isOverlayOpen) this.closeOverlay();
  }
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkfictional_university_block_theme"] = globalThis["webpackChunkfictional_university_block_theme"] || [];
