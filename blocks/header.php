		...
		<div class="site-header__menu group">
			<nav class="main-navigation">
				<ul>
					...
					<li <?php echo get_post_type() == 'program' ? 'class="current-menu-item"' : ''; ?>><a
					...
					<li <?php echo get_post_type() == 'campus' ? 'class="current-menu-item"' : ''; ?>><a
							href="<?php echo get_post_type_archive_link( 'campus' ); ?>">Campuses</a></li>
					<li <?php echo get_post_type() == 'post' ? 'class="current-menu-item"' : ''; ?>><a
			...
			<div class="site-header__util">
				...
				if ( is_user_logged_in() ) : ?>
					...
					<a href="<?php echo esc_url( wp_logout_url() ); ?>"
						class="btn--with-photo btn btn--small btn--dark-orange float-left">
